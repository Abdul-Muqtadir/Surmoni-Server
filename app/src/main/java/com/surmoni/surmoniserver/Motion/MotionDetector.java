    ...
    private Camera getCameraInstance(){
        ...
        try {
            if (Camera.getNumberOfCameras() >= 2) {
                ...
                SharedPreferences camera_prefs = MotionActivity.context.getSharedPreferences("com.surmoni.server.motion_camera",MODE_PRIVATE);
                if(camera_prefs.contains("motion_camera_position"))
                {
                    String data=camera_prefs.getString("motion_camera_position",null);
